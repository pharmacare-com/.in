...
export const translations: Record<'en' | 'hi', LanguageDict> = {
  en: {
    heroBadge: "100% Free App & Unlimited Cloud Storage",
    heroTagline: "Make Your Medical Store Digital with PharmaCare",
    heroSub: "The ultimate offline-first mobile assistant for smart pharmacists. Create automated bills, securely backup data to your own Google Drive with unlimited cloud storage, manage medicine inventory, and keep track of customer credits (Udhari Khata) in one neat app.",
    freeBadge: "100% Free App & Unlimited Cloud Storage",
    ...
    featuresSub: "Designed to be incredibly fast, super reliable, and fully offline with unlimited Google Drive cloud storage. Explore the interactive simulators below to see how PharmaCare works!",
    ...
    donationSub: "PharmaCare is 100% Free with unlimited cloud storage on your own Google Drive. It is built to help small pharmacy owners digitize their business without paying heavy monthly fees. If you love this project, please consider donating to support active development!",
  ...
  hi: {
    heroBadge: "100% फ्री और अनलिमिटेड क्लाउड स्टोरेज",
    heroTagline: "PharmaCare के साथ अपने मेडिकल स्टोर को बनाएं डिजिटल",
    heroSub: "स्मार्ट फार्मासिस्टों के लिए बेहतरीन ऑफलाइन-फर्स्ट मोबाइल असिस्टेंट। ऑटोमैटिक बिल बनाएं, अपने स्वयं के Google Drive पर अनलिमिटेड क्लाउड स्टोरेज के साथ सुरक्षित बैकअप लें, दवाओं के स्टॉक का प्रबंधन करें और उधारी खाता का आसान रिकॉर्ड रखें।",
    freeBadge: "100% फ्री ऐप, अनलिमिटेड क्लाउड स्टोरेज",
    ...
    featuresSub: "अत्यंत तेज, विश्वसनीय और अनलिमिटेड गूगल ड्राइव क्लाउड स्टोरेज के साथ डिजाइन। नीचे दिए गए सिमुलेटर देखें!",
    ...
    donationSub: "PharmaCare 100% फ्री है और आपके गूगल ड्राइव पर अनलिमिटेड क्लाउड स्टोरेज बैकअप के साथ है। इसे इसलिए बनाया गया है ताकि छोटे फार्मेसी और मेडिकल स्टोर मालिक बिना किसी मासिक शुल्क के अपने बिजनेस को डिजिटल बना सकें। यदि आपको यह काम पसंद आया, तो कृपया प्रोजेक्ट को जारी रखने के लिए डोनेशन दें!",
